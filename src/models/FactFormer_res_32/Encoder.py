...
from src.models.diffusion.FactFormer.layers import TimeEmbedding, PatchEmbedding
from src.models.diffusion.FactFormer.libs.factorization_module import FABlock2D
from src.models.diffusion.FactFormer.libs.positional_encoding_module import GaussianFourierFeatureTransform
...
class FactorizedTransformer(nn.Module):
    def __init__(self,
        ...
        for _ in range(depth):
            ...
            layer = nn.ModuleList([])
            layer.append(TimeEmbedding(100, dim))
    ...
    def forward(self, u, t):
        ...
        for time_1, pos_enc, time_2, attn_layer in self.layers:
            u = einops.rearrange(u, "b h w c-> b c h w")
            u = time_1(u, t)
            u = einops.rearrange(u, "b c h w -> b h w c")
