...
def get_config():
    ...
    config.encoder_conv_block.image_size = config.image_size
    ...
    config.swin_encoder.image_size = config.image_size
...
#########  DECODER  ##############
    ...
    config.swin_decoder.image_size = config.image_size
