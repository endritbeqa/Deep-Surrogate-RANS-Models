...
def get_config():
    ...
    config.CNN_decoder.input_dim =  [config.dim, config.dim,    config.dim//2, config.dim // 2, config.dim//4, config.dim // 4]
    config.CNN_decoder.hidden_dim = [config.dim, config.dim,    config.dim//2, config.dim // 2, config.dim//4, config.dim // 4]
    config.CNN_decoder.output_dim = [config.dim, config.dim//2, config.dim//2, config.dim // 4, config.dim//4, 3]
