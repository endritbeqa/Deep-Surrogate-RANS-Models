...
![](results/steady/tiny/predictions/images/e342_9554_661.png)

2. ** ViT-CNN (~2 million parameters):**  Achieved 9.1% mean relative error.

![](results/steady/Steady/res128/DiT/evaluation/images/goe501_1056_138.png)

3. ** FactFormer-CNN (~2 million parameters):** Achieved 3% mean relative error.

![](results/steady/Steady/res128/FactFormer/evaluation/images/e221_9303_-3092.png)

4. ** SwinV2-CNN (~2 million parameters):** Achieved % mean relative error.

![](results/steady/Steady/res128/Swin/evaluation/images/ah94156_4596_668.png)
